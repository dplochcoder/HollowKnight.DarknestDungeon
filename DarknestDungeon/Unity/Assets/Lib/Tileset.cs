...
namespace DarknestDungeon.Lib
{
    ...
    public static class DefaultTilesets
    {
        ...
        static DefaultTilesets()
        {
            ...
            templeBrick.AddTileId(23, 1, RIGHT, UP, UP_LEFT, LEFT, DOWN_LEFT, DOWN);
            templeBrick.AddTileId(24, 1, UP);
            templeBrick.AddTileId(25, 1, UP, RIGHT);
            templeBrick.AddTileId(26, 1, LEFT, UP, RIGHT);
            templeBrick.AddTileId(27, 1, LEFT, UP);
            templeBrick.AddTileId(28, 1, UP, UP_RIGHT, RIGHT, DOWN);
            templeBrick.AddTileId(29, 1, LEFT, UP_LEFT, UP, UP_RIGHT, RIGHT, DOWN_RIGHT, DOWN);
            templeBrick.AddTileId(30, 1, RIGHT, UP_RIGHT, UP, UP_LEFT, LEFT, DOWN_LEFT, DOWN);
            templeBrick.AddTileId(31, 1, DOWN, UP, UP_LEFT, LEFT);
            templeBrick.AddTileId(32, 1, LEFT, UP, UP_RIGHT, RIGHT, DOWN_RIGHT, DOWN);
            templeBrick.AddTileId(33, 1, RIGHT, UP_RIGHT, UP, UP_LEFT, LEFT, DOWN_LEFT, DOWN, DOWN_RIGHT);
            templeBrick.AddTileId(34, 1, UP, UP_LEFT, LEFT, DOWN, DOWN_RIGHT, RIGHT);
            templeBrick.AddTileId(35, 1, UP, UP_LEFT, LEFT, DOWN_LEFT, DOWN);
            templeBrick.AddTileId(36, 1);
            templeBrick.AddTileId(37, 1, RIGHT);
            templeBrick.AddTileId(38, 1, LEFT, RIGHT);
            templeBrick.AddTileId(39, 1, LEFT);
            templeBrick.AddTileId(40, 1, UP, RIGHT, DOWN, DOWN_LEFT, LEFT);
            templeBrick.AddTileId(41, 1, LEFT, UP, UP_RIGHT, RIGHT);
            templeBrick.AddTileId(42, 1, RIGHT, UP, UP_LEFT, LEFT);
            templeBrick.AddTileId(43, 1, UP, LEFT, DOWN, DOWN_RIGHT, RIGHT);
            templeBrick.AddTileId(44, 1, UP, UP_RIGHT, RIGHT);
            templeBrick.AddTileId(45, 1, LEFT, UP_LEFT, UP, UP_RIGHT, RIGHT);
            templeBrick.AddTileId(46, 1, LEFT, UP_LEFT, UP, UP_RIGHT, RIGHT, DOWN);
            templeBrick.AddTileId(47, 1, UP, UP_LEFT, LEFT);
            ...
            templeBrick.AddTileId(50, 1, LEFT, DOWN_LEFT, DOWN, DOWN_RIGHT, RIGHT);
            templeBrick.AddTileId(51, 1);
            templeBrick.AddTileId(52, 1);
            templeBrick.AddTileId(53, 1, UP, UP_RIGHT, RIGHT, DOWN_RIGHT, DOWN);
            templeBrick.AddTileId(54, 1, UP, UP_LEFT, LEFT, DOWN_LEFT, DOWN);
            templeBrick.AddTileId(55, 1, LEFT, UP_LEFT, UP, UP_RIGHT, RIGHT);
