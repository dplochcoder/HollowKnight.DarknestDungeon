...
namespace DarknestDungeon.Scripts
{
    public class PatchSceneManager : MonoBehaviour
    {
        ...
        public MapZone mapZone = MapZone.ABYSS_DEEP;
        ...
        public AnimationCurve redChannel = new AnimationCurve(new Keyframe[] { new Keyframe(0, 0), new Keyframe(1, 1) });
        public AnimationCurve greenChannel = new AnimationCurve(new Keyframe[] { new Keyframe(0, 0), new Keyframe(1, 1) });
        public AnimationCurve blueChannel = new AnimationCurve(new Keyframe[] { new Keyframe(0, 0), new Keyframe(1, 1) });
